...
<table width="1025" height="" border="0" align="<?=$SITE_ALIGN?>" cellpadding="0" cellspacing="0" id="Table_01">
  <tr>
    <td colspan="13"><img src="images/<?=$top;?>" width="1024" height="160" alt=""></td>
  ...
  <tr>
    ...
    <td rowspan="3"><a target="_blank" href="../HScatalogue2005.pdf" 
				onmouseover="window.status='../HScatalogue2005.pdf'; changeImages('Handling', 'images/Handling-over.jpg'); return true;"
				...
				onmouseup="changeImages('Handling', 'images/Handling-over.jpg'); return true;"> <img name="Handling" src="images/Handling.jpg" width="110" height="66" border="0" alt="../HScatalogue2005.pdf"></a></td>
    ...
    <td colspan="2" rowspan="3"><a href="contacts.php?lang=<?=$lang;?>"
    ...
    <td rowspan="3"><img src="images/Main-F_11.gif" width="127" height="66" alt=""></td>
...
HTML;
    ...
    <td><a target="_blank" href="../HScatalogue2005.pdf"
    ...
    <td colspan="2"><a href="contacts.php?lang=<?=$lang;?>"
    ...
    <td colspan="2"><a href="ndocs.php?lang=<?=$lang;?>"
				onmouseover="window.status='ndocs.php?lang=<?=$lang;?>'; changeImages('ndocs40', 'images/<?=$ndocs_up;?>'); return true;"
				onmouseout="window.status=''; changeImages('ndocs40', 'images/<?=$ndocs;?>'); return true;"
				onmousedown="changeImages('ndocs40', 'images/<?=$ndocs_up;?>'); return true;"
				onmouseup="changeImages('ndocs40', 'images/<?=$ndocs_up;?>'); return true;"> <img src="images/<?=$ndocs;?>" alt="" name="ndocs40" width="130" height="21" border="0" id="ndocs40"></a></td>



;'<td><img src="images/ButtonLineRight.gif" width="0" height="22" alt=""></td>
