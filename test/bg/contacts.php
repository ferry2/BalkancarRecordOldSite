		...
		if (isset($_POST['Offer']) && $_POST['Offer'] == "checked"){
          ...
          <tr>
            <td><table width=100% border=0 bgcolor=#E6FFEE>
              ...
              <tr>
                <td><div align=right><font id=labelLoadWeight class=disabledText>Тегло на товара /кг/:&nbsp;</font></div></td>
                <td>$LoadWeight</td>
              </tr>
              <tr>
...
function SelectSupplyType(){
	...
	if( document.theForm.MachineType.value == 'мотокар' )
	{
		...
		document.theForm.LoadWeight.options[10]=new Option("6000", 6000, false, false);
		document.theForm.LoadWeight.options[11]=new Option("7000", 7000, false, false);
		document.theForm.LoadWeight.options[12]=new Option("8000", 8000, false, false);
	...
	{
		document.theForm.SupplyType.options[0]=new Option("<?=$contacts_text[57]?>", "електро", true, true);
		...
		document.theForm.LoadWeight.options[2]=new Option("3500", 3500, false, false);
		document.theForm.LoadWeight.options[3]=new Option("4000", 4000, false, false);
		document.theForm.LoadWeight.options[4]=new Option("5000", 5000, false, false);
		document.theForm.LoadWeight.options[2]=new Option("6000", 6000, false, false);
		document.theForm.LoadWeight.options[3]=new Option("7000", 7000, false, false);
		document.theForm.LoadWeight.options[4]=new Option("8000", 8000, false, false);
		...
		document.theForm.System.options[3]=new Option("<?=$contacts_text[69]?>", "триплекс", false, false);
	...
	if( document.theForm.MachineType.value == 'платформа') 
	{
		...
		document.theForm.LoadWeight.options[0]=new Option("<?=$contacts_text[54]?>", "", true, true);
		document.theForm.LoadWeight.options[1]=new Option("5000", 5000, false, false);
		document.theForm.LoadWeight.options[2]=new Option("10000", 10000, false, false);
		document.theForm.LoadWeight.options[3]=new Option("15000", 15000, false, false);
	...
	if( document.theForm.MachineType.value == 'влекач' )
	{
		...
		document.getElementById("labelLW").innerHTML = "<?=$contacts_text[87]?>";
		
		document.theForm.SupplyType.options[0]=new Option("<?=$contacts_text[54]?>", "", true, true);
		document.theForm.SupplyType.options[1]=new Option("<?=$contacts_text[55]?>", "дизел", false, false);
		document.theForm.SupplyType.options[2]=new Option("<?=$contacts_text[57]?>", "електро", false, false);
	...
	if( document.theForm.MachineType.value == 'ретрак') 
	{
		...
		document.theForm.TyreTypes.options[0]=new Option("<?=$contacts_text[85]?>", "вулколан", true, true);
		
	}
	else if (document.theForm.MachineType.value != '')
	{
	...
	else if (document.theForm.MachineType.value != '')
	{
		...
		document.theForm.LoadCenter.options[2]=new Option("600", "600", false, false);
		document.theForm.LoadCenter.options[3]=new Option("<?=$contacts_text[61]?>", "друг", false, false);
	}
...
function SelectLoadWeights(){
	...
	if (document.theForm.MachineType.value == 'влекач')
	{
		...
		{
			document.theForm.LoadWeight.options[0]=new Option("<?=$contacts_text[54]?>", "", true, true);
			document.theForm.LoadWeight.options[1]=new Option("12,5", "12,5", false, false);
			document.theForm.LoadWeight.options[2]=new Option("16", "16", false, false);
			document.theForm.LoadWeight.options[3]=new Option("20", "20", false, false);
		}
		else if( document.theForm.SupplyType.value == 'електро')
		{
...
function SelectMaxHeights(){
	...
	if( document.theForm.MachineType.value == 'мотокар' )
	{
		if ( document.theForm.LoadWeight.value <= 2000 )
		{
			document.theForm.MaxHeight.options[0]=new Option("<?=$contacts_text[54]?>", "", true, true);
			document.theForm.MaxHeight.options[1]=new Option("3000", "3000", false, false);
			document.theForm.MaxHeight.options[2]=new Option("4000", "4000", false, false);
		...
		if ( document.theForm.LoadWeight.value > 2000 && document.theForm.LoadWeight.value < 6000 )
		{
			document.theForm.MaxHeight.options[0]=new Option("<?=$contacts_text[54]?>", "", true, true);
			document.theForm.MaxHeight.options[1]=new Option("3000", "3000", false, false);
			document.theForm.MaxHeight.options[2]=new Option("4000", "4000", false, false);
		...
		if ( document.theForm.LoadWeight.value >= 6000 )
		{
			document.theForm.MaxHeight.options[0]=new Option("<?=$contacts_text[54]?>", "", true, true);
                              ...
                              <tr>
                                <td><table width="100%" border="0" bgcolor="#E6FFEE">
                                  ...
                                  <tr>
									...
									<label for="MachineType" id="labelLW"><?=$contacts_text[58];?></label><br></font></td>
                                  ...
                                  <tr>
                                    ...
                                    <td><select id="MaxHeight" name="MaxHeight">
											<option value="" selected><?=$contacts_text[84]?></option>
										</select>
										<script type="text/javascript">
