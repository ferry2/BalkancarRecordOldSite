    ...
    <td width="799"><table width="1025" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="853" valign="top"><table width="850" height="520" border="0" cellpadding="5" cellspacing="5">
          <tr>
            <td height="18" class="headerfon"><a href="elcars.php?lang=<?=$lang?>"><?=$txt[9]?></a> <font class="navnext">&gt;&gt;</font> <?=$elcars_text[9]?> </td>
            </tr>
          <tr>
            <td valign="top" class="textfon"><table width="102%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="2"><img src="../images/elcar8000.gif" alt="er_specs" width="400" height="245"></td>
                <td><table width="409" height="187" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
                  ...
                  <tr bgcolor="#E9EEF1">
                    <td width="100" height="49" align="center"><div align="center">6000 </div></td>
                    <td width="80" rowspan="3" align="center"><a href="<?php echo $pref;?>record-er8-bg.pdf" target="_blank">DC</a></td>
                    <td width="70" rowspan="3" align="center">AC</td>
                    <td width="67" align="center">DC</td>
                    <td width="60" align="center">AC</td>
                  </tr>
                  <tr bgcolor="#E9EEF1">
                    <td width="100" height="49" align="center"><div align="center">7000</div></td>
                    <td align="center">DC</td>
                    <td align="center">AC</td>
                  </tr>
                  <tr bgcolor="#E9EEF1">
                    <td width="100" height="37" align="center" valign="CENTER"> 8000 </td>
                    <td width="67" align="center">DC</td>
                    <td width="60" align="center">AC</td>
                  </tr>
