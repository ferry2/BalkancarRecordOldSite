          ...
          <tr>
            <td height="1353" valign="top" class="textfon"><table width="715" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
                      <tr> 
                        ...
                        <td width="232" align="center" valign="top" bgcolor="#E9EEF1"><p class="DropDownCat"><a href="javascript:popUp('popcert.php?pic=img007_big.jpg');"><br>
                            <img src="images/certificates/img007_small.jpg" alt="1" width="200" border="0"><br>
                            </a><br>
                          </p></td>
...
<?
				switch ($lang){
					case "bg":
                        print "<a href=\"javascript:popUp('popcert.php?pic=BALKANCAR-RECORD_PLC_9001_BG_2013_big.jpg');\"><img src=\"images/certificates/BALKANCAR-RECORD_PLC_9001_BG_2013_small.jpg\" alt=\"1\" width=\"200\" height=\"284\" border=\"0\"><br>";
						break;
					case "en":
						print "<a href=\"javascript:popUp('popcert.php?pic=BALKANCAR-RECORD_PLC_9001_EN_2013_big.jpg');\"><img src=\"images/certificates/BALKANCAR-RECORD_PLC_9001_EN_2013_small.jpg\" alt=\"1\" width=\"200\" height=\"284\" border=\"0\"><br>";
						break;
					case "ru":
						print  "<a href=\"javascript:popUp('popcert.php?pic=BALKANCAR-RECORD_PLC_9001_BG_2013_big');\"><img src=\"images/certificates/BALKANCAR-RECORD_PLC_9001_BG_2013_small.jpg\" alt=\"1\" width=\"200\" height=\"284\" border=\"0\"><br>";
						break;
				}
?>
                          </a></span></td>
...
<?
				switch ($lang){
					case "bg":
                        print "<a href=\"javascript:popUp('popcert.php?pic=dekl_bg_big.jpg');\"><img src=\"images/certificates/dekl_bg_small.jpg\" alt=\"1\" width=\"200\" height=\"284\" border=\"0\"><br>";
						break;
					case "en":
						print "<a href=\"javascript:popUp('popcert.php?pic=dekl_en_big.jpg');\"><img src=\"images/certificates/dekl_en_small.jpg\" alt=\"1\" width=\"200\" height=\"284\" border=\"0\"><br>";
						break;
					case "ru":
						print  "<a href=\"javascript:popUp('popcert.php?pic=dekl_ru_big.jpg');\"><img src=\"images/certificates/dekl_ru_small.jpg\" alt=\"1\" width=\"200\" height=\"284\" border=\"0\"><br>";
						break;
				}
?>
                          </a></span></td>
					  <td align="center" valign="top" bgcolor="#E9EEF1"><a href="javascript:popUp('popcert.php?pic=img010_big.jpg');"><br>
