          ...
          <tr>
                <td valign="top" class="textfon"> <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					if (!(isset($next) && $next == 'step2' && isset($enter))){
						print "<form class=\"textfon\" name=\"theForm\" method=\"post\" action=\"register.php?lang=$lang\">";
					}
				?>							  
							...
							if (isset($payment) && $payment == $_SESSION['succ']){
								...
								switch ($lang){
									...
									case "en":
										...
										break;
									case "ru":
										$mail_body = "<html><body>Здраствуйте!<br><br>Это код для доступ каталозы запасных частей: <b>$accessCode</b><br>Вы смогли входить от сюда: <a href=http://www.balkancar-record.com/bg/register.php?lang=$lang>www.balkancar-record.com/bg/register.php?lang=$lang</a><br><br>Благодарим Вам для проявлены интерес.</body></html>";
										break;
								}
					...
					if (isset($next) && $next == 'step2'){
							...
							if ($check_email == $fetched_mail && $status == 'F'){
								...
								print $txt[52]."<strong>".$email."</strong>".$txt[68]." <a href=http://$HTTP_HOST/register.php?lang=$lang>".$txt[69]." <a href=http://$HTTP_HOST/register.php?lang=$lang&lostcode=$email>".$txt[70];
...
<a href=http://$HTTP_HOST/register.php?lang=$lang><strong>$txt[57]</strong></a>
</td>
</tr>
<tr>
...
<input type=hidden name=URL_OK value="http://$HTTP_HOST/register.php?lang=bg&payment=$succ">
<input type=hidden name=URL_CANCEL value="http://$HTTP_HOST/register.php?lang=bg&payment=false">
</form>
HTML;
